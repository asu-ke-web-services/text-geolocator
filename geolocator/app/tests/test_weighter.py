        ...
        container.append(
            LocationHits(
                ...
                [LocationWrap(
                    Location(
                        Arizona,
                        -1, Arizona, '???', '???', '???', '???', -35.72259, -65.31972, 0))\nLocationAdminNames(countryname='Argentina', admin1name='Provincia de San Luis', admin2name='None', admin3name='None', admin4name='None')", u"LocationWrap(Location(Arizona, -1, Arizona, '???', '???', '???', '???', -23.11667, 149.2, 0))\nLocationAdminNames(countryname='Australia', admin1name='State of Queensland', admin2name='Central Highlands', admin3name='None', admin4name='None')", u"LocationWrap(Location(Arizona, -1, Arizona, '???', '???', '???', '???', -21.66667, 141.55, 0))\nLocationAdminNames(countryname='Australia', admin1name='State of Queensland', admin2name='McKinlay', admin3name='None', admin4name='None')", u"LocationWrap(Location(Arizona, -1, Arizona, '???', '???', '???', '???', -19.53333, 141.35001, 0))\nLocationAdminNames(countryname='Australia', admin1name='State of Queensland', admin2name='McKinlay', admin3name='None', admin4name='None')", u"LocationWrap(Location(Arizona, -1, Arizona, '???', '???', '???', '???', -30.48236, 116.867, 0))\nLocationAdminNames(countryname='Australia', admin1name='State of Western Australia', admin2name='Dalwallinu', admin3name='None', admin4name='None')", u"LocationWrap(Location(Arizona, -1, Arizona, '???', '???', '???', '???', -34.53529, 117.88443, 0))\nLocationAdminNames(countryname='Australia', admin1name='State of Western Australia', admin2name='Plantagenet Shire', admin3name='None', admin4name='None')", u"LocationWrap(Location(Arizona, -1, Arizona, '???', '???', '???', '???', -33.30794, 118.66646, 0))\nLocationAdminNames(countryname='Australia', admin1name='State of Western Australia', admin2name='Lake Grace', admin3name='None', admin4name='None')", u"LocationWrap(Location(Arizona, -1, Arizona, '???', '???', '???', '???', -32.49089, 151.40037, 0))\nLocationAdminNames(countryname='Australia', admin1name='State of New South Wales', admin2name='Singleton', admin3name='None', admin4name='None')", u"LocationWrap(Location(Arizona, -1, Arizona, '???', '???', '???', '???', -35.0347, 146.52509, 0))\nLocationAdminNames(countryname='Australia', admin1name='State of New South Wales', admin2name='Urana', admin3name='None', admin4name='None')", u"LocationWrap(Location(Arizona, -1, Arizona, '???', '???', '???', '???', -8.66667, -40.95, 0))\nLocationAdminNames(countryname='Brazil', admin1name='Pernambuco', admin2name='Afr\xe2nio', admin3name='None', admin4name='None')", u"LocationWrap(Location(Arizona, -1, Arizona, '???', '???', '???', '???', -6.45, -41.58333, 0))\nLocationAdminNames(countryname='Brazil', admin1name='Piau\xed', admin2name='Lagoa do S\xedtio', admin3name='None', admin4name='None')", u"LocationWrap(Location(Arizona, -1, Arizona, '???', '???', '???', '???', -5.56667, -35.78333, 0))\nLocationAdminNames(countryname='Brazil', admin1name='Rio Grande do Norte', admin2name='Jo\xe3o C\xe2mara', admin3name='None', admin4name='None')", u"LocationWrap(Location(Arizona, -1, Arizona, '???', '???', '???', '???', -5.28333, -35.7, 0))\nLocationAdminNames(countryname='Brazil', admin1name='Rio Grande do Norte', admin2name='Touros', admin3name='None', admin4name='None')", u"LocationWrap(Location(Arizona, -1, Arizona, '???', '???', '???', '???', -16.21667, -40.06667, 0))\nLocationAdminNames(countryname='Brazil', admin1name='Minas Gerais', admin2name='Salto da Divisa', admin3name='None', admin4name='None')", u"LocationWrap(Location(Arizona, -1, Arizona, '???', '???', '???', '???', -12.8, -40.93333, 0))\nLocationAdminNames(countryname='Brazil', admin1name='Bahia', admin2name='Boa Vista do Tupim', admin3name='None', admin4name='None')", u"LocationWrap(Location(Arizona, -1, Arizona, '???', '???', '???', '???', -8.68222, -40.96139, 0))\nLocationAdminNames(countryname='Brazil', admin1name='Pernambuco', admin2name='Afr\xe2nio', admin3name='None', admin4name='None')", u"LocationWrap(Location(Arizona, -1, Arizona, '???', '???', '???', '???', -8.75436, -40.91927, 0))\nLocationAdminNames(countryname='Brazil', admin1name='Pernambuco', admin2name='Afr\xe2nio', admin3name='None', admin4name='None')", u"LocationWrap(Location(Arizona, -1, Arizona, '???', '???', '???', '???', 49.82832, -99.02859, 0))\nLocationAdminNames(countryname='Canada', admin1name='Manitoba', admin2name='None', admin3name='None', admin4name='None')", u"LocationWrap(Location(Arizona, -1, Arizona, '???', '???', '???', '???', -24.58333, -70.0, 0))\nLocationAdminNames(countryname='Chile', admin1name='Antofagasta', admin2name='Provincia de Antofagasta', admin3name='None', admin4name='None')", u"LocationWrap(Location(Arizona, -1, Arizona, '???', '???', '???', '???', -30.4, -70.16667, 0))\nLocationAdminNames(countryname='Chile', admin1name='Coquimbo', admin2name='Provincia de Elqui', admin3name='None', admin4name='None')", u"LocationWrap(Location(Arizona, -1, Arizona, '???', '???', '???', '???', 10.57197, -74.13696, 0))\nLocationAdminNames(countryname='Colombia', admin1name='Departamento del Magdalena', admin2name='None', admin3name='None', admin4name='None')", u"LocationWrap(Location(Arizona, -1, Arizona, '???', '???', '???', '???', 10.48333, -75.43333, 0))\nLocationAdminNames(countryname='Colombia', admin1name='Departamento de Bol\xedvar', admin2name='None', admin3name='None', admin4name='None')", u"LocationWrap(Location(Arizona, -1, Arizona, '???', '???', '???', '???', 4.04375, -72.96845, 0))\nLocationAdminNames(countryname='Colombia', admin1name='Departamento del Meta', admin2name='None', admin3name='None', admin4name='None')", u"LocationWrap(Location(Arizona, -1, Arizona, '???', '???', '???', '???', 2.72084, -72.28228, 0))\nLocationAdminNames(countryname='Colombia', admin1name='Departamento del Guaviare', admin2name='None', admin3name='None', admin4name='None')", u"LocationWrap(Location(Arizona, -1, Arizona, '???', '???', '???', '???', 6.81806, -70.76, 0))\nLocationAdminNames(countryname='Colombia', admin1name='Departamento de Arauca', admin2name='None', admin3name='None', admin4name='None')", u"LocationWrap(Location(Arizona, -1, Arizona, '???', '???', '???', '???', 5.97167, -71.81694, 0))\nLocationAdminNames(countryname='Colombia', admin1name='Departamento de Casanare', admin2name='None', admin3name='None', admin4name='None')", u"LocationWrap(Location(Arizona, -1, Arizona, '???', '???', '???', '???', 5.93889, -70.97944, 0))\nLocationAdminNames(countryname='Colombia', admin1name='Departamento de Casanare', admin2name='None', admin3name='None', admin4name='None')", u"LocationWrap(Location(Arizona, -1, Arizona, '???', '???', '???', '???', 2.17809, -74.5573, 0))\nLocationAdminNames(countryname='Colombia', admin1name='Departamento del Meta', admin2name='None', admin3name='None', admin4name='None')", u"LocationWrap(Location(Arizona, -1, Arizona, '???', '???', '???', '???', 3.32008, -73.50162, 0))\nLocationAdminNames(countryname='Colombia', admin1name='Departamento del Meta', admin2name='None', admin3name='None', admin4name='None')", u"LocationWrap(Location(Arizona, -1, Arizona, '???', '???', '???', '???', 10.36374, -73.48162, 0))\nLocationAdminNames(countryname='Colombia', admin1name='Departamento del Cesar', admin2name='None', admin3name='None', admin4name='None')", u"LocationWrap(Location(Arizona, -1, Arizona, '???', '???', '???', '???', 10.19707, -84.95201, 0))\nLocationAdminNames(countryname='Costa Rica', admin1name='Provincia de Guanacaste', admin2name='None', admin3name='None', admin4name='None')", u"LocationWrap(Location(Arizona, -1, Arizona, '???', '???', '???', '???', 27.79, -15.7, 0))\nLocationAdminNames(countryname='Spain', admin1name='Canary Islands', admin2name='Provincia de Las Palmas', admin3name='None', admin4name='None')", u"LocationWrap(Location(Arizona, -1, Arizona, '???', '???', '???', '???', 13.95806, -90.82028, 0))\nLocationAdminNames(countryname='Guatemala', admin1name='Departamento de Escuintla', admin2name='None', admin3name='None', admin4name='None')", u"LocationWrap(Location(Arizona, -1, Arizona, '???', '???', '???', '???', 15.63333, -87.31667, 0))\nLocationAdminNames(countryname='Honduras', admin1name='Departamento de Atl\xe1ntida', admin2name='None', admin3name='None', admin4name='None')", u"LocationWrap(Location(Arizona, -1, Arizona, '???', '???', '???', '???', 15.68333, -87.33333, 0))\nLocationAdminNames(countryname='Honduras', admin1name='Departamento de Atl\xe1ntida', admin2name='Arizona', admin3name='None', admin4name='None')", u"LocationWrap(Location(Arizona, -1, Arizona, '???', '???', '???', '???', 44.13157, 12.48532, 0))\nLocationAdminNames(countryname='Italy', admin1name='Emilia-Romagna', admin2name='Provincia di Rimini', admin3name='None', admin4name='None')", u"LocationWrap(Location(Arizona, -1, Arizona, '???', '???', '???', '???', 20.91744, -87.46447, 0))\nLocationAdminNames(countryname='Mexico', admin1name='Estado de Quintana Roo', admin2name='None', admin3name='None', admin4name='None')", u"LocationWrap(Location(Arizona, -1, Arizona, '???', '???', '???', '???', 30.45639, -109.46373, 0))\nLocationAdminNames(countryname='Mexico', admin1name='Estado de Sonora', admin2name='None', admin3name='None', admin4name='None')", u"LocationWrap(Location(Arizona, -1, Arizona, '???', '???', '???', '???', 22.9128, -99.11055, 0))\nLocationAdminNames(countryname='Mexico', admin1name='Estado de Tamaulipas', admin2name='None', admin3name='None', admin4name='None')", u"LocationWrap(Location(Arizona, -1, Arizona, '???', '???', '???', '???', 17.03278, -92.34472, 0))\nLocationAdminNames(countryname='Mexico', admin1name='Estado de Chiapas', admin2name='Sital\xe1', admin3name='None', admin4name='None')", u"LocationWrap(Location(Arizona, -1, Arizona, '???', '???', '???', '???', 15.62028, -93.18833, 0))\nLocationAdminNames(countryname='Mexico', admin1name='Estado de Chiapas', admin2name='Pijijiapan', admin3name='None', admin4name='None')", u"LocationWrap(Location(Arizona, -1, Arizona, '???', '???', '???', '???', 21.42886, -87.70516, 0))\nLocationAdminNames(countryname='Mexico', admin1name='Estado de Yucat\xe1n', admin2name='None', admin3name='None', admin4name='None')", u"LocationWrap(Location(Arizona, -1, Arizona, '???', '???', '???', '???', -23.2, 16.03333, 0))\nLocationAdminNames(countryname='Namibia', admin1name='Khomas', admin2name='None', admin3name='None', admin4name='None')", u"LocationWrap(Location(Arizona, -1, Arizona, '???', '???', '???', '???', -27.73333, 19.8, 0))\nLocationAdminNames(countryname='Namibia', admin1name='Karas', admin2name='None', admin3name='None', admin4name='None')", u"LocationWrap(Location(Arizona, -1, Arizona, '???', '???', '???', '???', 32.78904, -92.95766, 0))\nLocationAdminNames(countryname='United States', admin1name='Louisiana', admin2name='Claiborne Parish', admin3name='None', admin4name='None')", u"LocationWrap(Location(Arizona, -1, Arizona, '???', '???', '???', '???', 30.78963, -95.468, 0))\nLocationAdminNames(countryname='United States', admin1name='Texas', admin2name='Walker County', admin3name='None', admin4name='None')", u"LocationWrap(Location(Arizona, -1, Arizona, '???', '???', '???', '???', 41.81443, -96.13363, 0))\nLocationAdminNames(countryname='United States', admin1name='Nebraska', admin2name='Burt County', admin3name='None', admin4name='None')", u"LocationWrap(Location(Arizona, -1, Arizona, '???', '???', '???', '???', 34.5003, -111.50098, 0))\nLocationAdminNames(countryname='United States', admin1name='Arizona', admin2name='None', admin3name='None', admin4name='None')", u"LocationWrap(Location(Arizona, -1, Arizona, '???', '???', '???', '???', -25.92325, 22.79326, 0))\nLocationAdminNames(countryname='South Africa', admin1name='Province of North West', admin2name='Dr Ruth Segomotsi Mompati District Municipality', admin3name='None', admin4name='None')", u"LocationWrap(Location(Arizona, -1, Arizona, '???', '???', '???', '???', -19.21667, 29.61667, 0))\nLocationAdminNames(countryname='Zimbabwe', admin1name='None', admin2name='None', admin3name='None', admin4name='None')", u"LocationWrap(Location(Arizona, -1, Arizona, '???', '???', '???', '???', -18.19478, 31.63905, 0))\nLocationAdminNames(countryname='Zimbabwe', admin1name='Mashonaland East Province', admin2name='None', admin3name='None', admin4name='None')", u"LocationWrap(Location(Arizona, -1, Arizona, '???', '???', '???', '???', -17.85918, 31.98619, 0))\nLocationAdminNames(countryname='Zimbabwe', admin1name='Mashonaland East Province', admin2name='None', admin3name='None', admin4name='None')"]))
container.append(LocationHits(Phoenix, [u"LocationWrap(Location(Phoenix, -1, Phoenix, '???', '???', '???', '???', 33.44838, -112.07404, 0))\nLocationAdminNames(countryname='United States', admin1name='Arizona', admin2name='Maricopa County', admin3name='None', admin4name='None')"])
)
