...
def MakeGeoJsonElement(location, existing_locations):
	...
	It only searches the name instead of the other parameters. Also because of first hit,
	the accuracy is not very good. Will need to add additional logic for checking"""
